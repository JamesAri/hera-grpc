...
const APP_NAME = `${process.env.OTEL_SERVICE_NAME}-${process.pid}` // TODO

/**
 * Interceptor for setting default metadata options which help with
 * tracing the clients and RPC calls.
 */
