...
module.exports = class GRPCClient {
	...
	createStub(clientOptions, parentCall) {
		...
		const options = {
			...
			...config.channelOptions, // TODO: test defining interceptors in clientOptions
			...
			// we force our service config, because in the future, this will be defined by the service
			// owners and registered in zookeeper
